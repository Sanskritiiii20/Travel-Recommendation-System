...
def main():
    ...
    st.markdown("Plan smarter: AI-powered vacation picks tailored to you.!")
    ...
    if choice == "Home":
        st.header("Welcome to Your Personalized Travel Recommender!")
        st.image("https://images.unsplash.com/photo-1542273917363-3b1817f69a2d",
